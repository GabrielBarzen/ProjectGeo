...
import se.gabnet.projectgeo.model.game.map.placeable.persistence.VertexRepository
import java.util.*
import kotlin.jvm.optionals.getOrElse


class VertexInputHandler(private val vertexRepository: VertexRepository) {
